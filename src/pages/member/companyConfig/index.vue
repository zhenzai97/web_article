  ...
  <PageLayout>
    ...
    <template #toolbar>
      <div class="toolbar-row">
        <el-button v-permission="PERM.memberCompanyConfig.add" type="primary" :icon="CirclePlus" @click="handleAdd">
          新增配置
        </el-button>
    ...
    <template #table>
      ...
      >
        ...
        <template #action="{ row }">
          <el-button v-permission="PERM.memberCompanyConfig.edit" type="primary" text bg size="small" @click="handleUpdate(row)">
            编辑
          </el-button>
          <el-button v-permission="PERM.memberCompanyConfig.delete" type="danger" text bg size="small" @click="handleDelete(row)">
            删除
          </el-button>
        </template>
      </TableList>
